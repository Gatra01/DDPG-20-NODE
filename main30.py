                    ...
                    if total_steps == opt.Max_train_steps:
                        ...
                        for i in range(3000):
                            ...
                            if opt.write: 
                                ...
                                writer.add_scalar('data_rate_20', result1['data_rate_10'], global_step=st)
                                writer.add_scalar('data_rate_22', result1['data_rate_12'], global_step=st)
                                writer.add_scalar('data_rate_23', result1['data_rate_13'], global_step=st)
                                writer.add_scalar('data_rate_24', result1['data_rate_14'], global_step=st)
                                writer.add_scalar('data_rate_26', result1['data_rate_16'], global_step=st)
                                writer.add_scalar('data_rate_27', result1['data_rate_17'], global_step=st)
                                writer.add_scalar('data_rate_28', result1['data_rate_18'], global_step=st)
                                writer.add_scalar('data_rate_29', result1['data_rate_19'], global_step=st)
                                writer.add_scalar('data_rate_21', result1['data_rate_17'], global_step=st)
                                writer.add_scalar('data_rate_25', result1['data_rate_18'], global_step=st)
                                writer.add_scalar('data_rate_30', result1['data_rate_19'], global_step=st)

...
from utils30 import str2bool,evaluate_policy
...
def main():
    ...
    if opt.render:
                        ...
                        for i in range(3000):
                           ...
                           # Simpan jarak antar node
                            ...
                            if opt.write: 
                                ...
                                writer.add_scalar('data_rate_20', result1['data_rate_20'], global_step=st)
                                writer.add_scalar('data_rate_22', result1['data_rate_22'], global_step=st)
                                writer.add_scalar('data_rate_23', result1['data_rate_23'], global_step=st)
                                writer.add_scalar('data_rate_24', result1['data_rate_24'], global_step=st)
                                writer.add_scalar('data_rate_26', result1['data_rate_26'], global_step=st)
                                writer.add_scalar('data_rate_27', result1['data_rate_27'], global_step=st)
                                writer.add_scalar('data_rate_28', result1['data_rate_28'], global_step=st)
                                writer.add_scalar('data_rate_29', result1['data_rate_29'], global_step=st)
                                writer.add_scalar('data_rate_21', result1['data_rate_21'], global_step=st)
                                writer.add_scalar('data_rate_25', result1['data_rate_25'], global_step=st)
                                writer.add_scalar('data_rate_30', result1['data_rate_30'], global_step=st)
        ...
        R_min = 0.048  # Ganti sesuai kebutuhan
        ...
        df = pd.DataFrame({
            ...
            'data_rate_24' :data_rate_24,
            'data_rate_27' :data_rate_27,
            'data_rate_30' :data_rate_30,

...
class GameState:
    ...
    def step(self,power,channel_gain,next_channel_gain):
        ...
        for i in range(self.nodes):
            data_rate_constraint.append(10e3*self.step_function(0.263-data_rate[i]))
        ...
        reward = EE -  10e3*self.step_function(total_daya-self.p_max)-np.sum(data_rate_constraint)

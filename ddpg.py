...
class DDPG_agent():
	def __init__(self, **kwargs):
		...
		self.actor_optimizer = torch.optim.RMSprop(self.actor.parameters(), lr=self.a_lr)
		self.actor_target = copy.deepcopy(self.actor)

		self.q_critic = Q_Critic(self.state_dim, self.action_dim, self.net_width).to(self.dvc)
		self.q_critic_optimizer = torch.optim.RMSprop(self.q_critic.parameters(), lr=self.c_lr)
